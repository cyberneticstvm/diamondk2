...
<head>
    ...
    <title>Core Cut Diamond Tools - Premium Diamond Tools and Power Tools Accessories Supplier</title>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="header-mid-one-wrapper">
                        <div class="logo-area">
                            <a href="{{ route('index') }}">
                                <img src="{{ asset('/assets/images/logo/logo1.png') }}" width="176" height="116" alt="K2 logo">
                            </a>
                        </div>
                        <div class="header-right">
                            ...
                            <div class="single-component info-con">
                                ...
                                <div class="info">
                                    ...
                                    <a href="#">K2 Abrasives Private Limited, Kinfra Industrial Park, Thonakkal, Trivandrum, Kerala, India</a>
                                </div>
                            </div>
                            <!-- sinle map area -->
                            <!-- sinle map area -->
                    ...
                    <div class="main-footer-wrapper-two">
                        <div class="single-footer-wized-two logo-area" data-sal="slide-up" data-sal-delay="150" data-sal-duration="800">
                            <a href="{{ route('index') }}" class="logo">
                                <img src="{{ asset('/assets/images/logo/logo2.png') }}" alt="K2 Logo">
                            </a>
                            <p class="disc-f">
                                We are a manufacturer of top-notch Diamond Tools and Power Tools Accessories in India.
                            </p>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="copyright-footer-two">
                            <p class="disc">
                                © {{ date('Y') }} DiamondK2. All rights reserved.
                            </p>
                        </div>
                    </div>
                </div>
